...
constexpr inline std::uint32_t _uint32_sels(
	std::uint32_t test, std::uint32_t a, std::uint32_t b
) noexcept {
...
constexpr inline std::uint32_t _uint32_selb(
	std::uint32_t mask, std::uint32_t a, std::uint32_t b
) noexcept {
	const std::uint32_t sel_a = (a & mask);
	const std::uint32_t sel_b = (b & ~mask);
	const std::uint32_t result = (sel_a | sel_b);
...
constexpr inline std::uint16_t _uint16_sels(
	std::uint16_t test, std::uint16_t a, std::uint16_t b
) noexcept {
...
namespace numeric {
constexpr inline const unsigned long version = 20210121UL;
#ifdef DEBUG
...
inline std::ostream& operator<<(std::ostream& os, const float16& f16) {
...
inline std::ostream& operator<<(std::ostream& os, const float32& f32) {
...
struct float16_t {
	...
	constexpr inline float16_t(int other) noexcept :
		data_ { float16_t_private::float32_to_float16(static_cast<float>(other)) } {}

	constexpr inline float16_t(std::uint16_t bits) noexcept : data_ { bits } {}

	constexpr inline float16_t& operator=(const float16_t&) noexcept = default;
	...
	constexpr inline operator std::uint16_t() const noexcept { return data_.bits_; }
	...
	constexpr inline float16_t operator+() const noexcept { return *this; }
...
constexpr inline bool operator<(float16_t lhs, float16_t rhs) noexcept {
	const auto& l_ieee = lhs.data_.ieee_;
	const auto& r_ieee = rhs.data_.ieee_;
...
std::basic_ostream<CharT, Traits>& operator<<(
	std::basic_ostream<CharT, Traits>& os, const float16_t& f
) {
...
namespace float16_t_private {
auto constexpr inline make_unary_function = [](const auto& func) noexcept {
	return [func](float16_t f) -> float16_t { return func(float(f)); };
};

auto constexpr inline make_binary_function = [](const auto& func) noexcept {
	return [func](float16_t f1, float16_t f2) -> float16_t { return func(float(f1), float(f2)); };
};

auto constexpr inline make_trinary_function = [](const auto& func) noexcept {
...
constexpr inline auto fmod =
	float16_t_private::make_binary_function([](float f1, float f2) { return std::fmod(f1, f2); });
constexpr inline auto remainder = float16_t_private::make_binary_function([](float f1, float f2) {
	return std::remainder(f1, f2);
});
// remquo ??
constexpr inline auto fma =
	float16_t_private::make_trinary_function([](float f1, float f2, float f3) {
		return std::fma(f1, f2, f3);
	});
constexpr inline auto fmax =
	float16_t_private::make_binary_function([](float f1, float f2) { return std::fmax(f1, f2); });
constexpr inline auto fmin =
	float16_t_private::make_binary_function([](float f1, float f2) { return std::fmax(f1, f2); });
constexpr inline auto fdim =
	float16_t_private::make_binary_function([](float f1, float f2) { return std::fdim(f1, f2); });
constexpr inline auto lerp =
	float16_t_private::make_trinary_function([](float f1, float f2, float f3) {
		return f1 + f3 * (f2 - f1);
	});
constexpr inline auto exp =
	float16_t_private::make_unary_function([](float f) { return std::exp(f); });
constexpr inline auto exp2 =
	float16_t_private::make_unary_function([](float f) { return std::exp2(f); });
constexpr inline auto expm1 =
	float16_t_private::make_unary_function([](float f) { return std::expm1(f); });
constexpr inline auto log =
	float16_t_private::make_unary_function([](float f) { return std::log(f); });
constexpr inline auto log10 =
	float16_t_private::make_unary_function([](float f) { return std::log10(f); });
constexpr inline auto log2 =
	float16_t_private::make_unary_function([](float f) { return std::log2(f); });
constexpr inline auto log1p =
	float16_t_private::make_unary_function([](float f) { return std::log1p(f); });
constexpr inline auto pow =
	float16_t_private::make_binary_function([](float f1, float f2) { return std::pow(f1, f2); });
constexpr inline auto sqrt =
	float16_t_private::make_unary_function([](float f) { return std::sqrt(f); });
constexpr inline auto cbrt =
	float16_t_private::make_unary_function([](float f) { return std::cbrt(f); });
...
constexpr inline auto sin =
	float16_t_private::make_unary_function([](float f) { return std::sin(f); });
constexpr inline auto sinh =
	float16_t_private::make_unary_function([](float f) { return std::sinh(f); });
constexpr inline auto cos =
	float16_t_private::make_unary_function([](float f) { return std::cos(f); });
constexpr inline auto cosh =
	float16_t_private::make_unary_function([](float f) { return std::cosh(f); });
constexpr inline auto tan =
	float16_t_private::make_unary_function([](float f) { return std::tan(f); });
constexpr inline auto tanh =
	float16_t_private::make_unary_function([](float f) { return std::tanh(f); });
constexpr inline auto asin =
	float16_t_private::make_unary_function([](float f) { return std::asin(f); });
constexpr inline auto asinh =
	float16_t_private::make_unary_function([](float f) { return std::asinh(f); });
constexpr inline auto acos =
	float16_t_private::make_unary_function([](float f) { return std::acos(f); });
constexpr inline auto acosh =
	float16_t_private::make_unary_function([](float f) { return std::acosh(f); });
constexpr inline auto atan =
	float16_t_private::make_unary_function([](float f) { return std::atan(f); });
constexpr inline auto atanh =
	float16_t_private::make_unary_function([](float f) { return std::atanh(f); });
constexpr inline auto atan2 =
	float16_t_private::make_binary_function([](float f1, float f2) { return std::atan2(f1, f2); });

constexpr inline auto erf =
	float16_t_private::make_unary_function([](float f) { return std::erf(f); });
constexpr inline auto erfc =
	float16_t_private::make_unary_function([](float f) { return std::erfc(f); });
constexpr inline auto tgamma =
	float16_t_private::make_unary_function([](float f) { return std::tgamma(f); });
constexpr inline auto lgamma =
	float16_t_private::make_unary_function([](float f) { return std::lgamma(f); });
constexpr inline auto ceil =
	float16_t_private::make_unary_function([](float f) { return std::ceil(f); });
constexpr inline auto floor =
	float16_t_private::make_unary_function([](float f) { return std::floor(f); });
constexpr inline auto trunc =
	float16_t_private::make_unary_function([](float f) { return std::trunc(f); });
constexpr inline auto round =
	float16_t_private::make_unary_function([](float f) { return std::round(f); });
constexpr inline auto nearbyint =
	float16_t_private::make_unary_function([](float f) { return std::nearbyint(f); });
constexpr inline auto rint =
	float16_t_private::make_unary_function([](float f) { return std::rint(f); });

// Floating point manipulation functions not defined
// frexp ldexp, modf, scalbn, ilogb

constexpr inline auto logb =
	float16_t_private::make_unary_function([](float f) { return std::logb(f); });
constexpr inline auto nextafter = float16_t_private::make_binary_function([](float f1, float f2) {
	return std::nextafter(f1, f2);
});
constexpr inline auto copysign = float16_t_private::make_binary_function([](float f1, float f2) {
	return std::copysign(f1, f2);
});
...
constexpr inline bool is_normal(float16_t f16) noexcept {
	const auto exponent = std::uint16_t(f16) & 0x7f80;
...
constexpr inline auto comp_ellint_3 =
	float16_t_private::make_binary_function([](float f1, float f2) {
		return std::comp_ellint_3(f1, f2);
	});
constexpr inline auto cyl_bessel_i =
	float16_t_private::make_binary_function([](float f1, float f2) {
		return std::cyl_bessel_i(f1, f2);
	});
constexpr inline auto cyl_bessel_j =
	float16_t_private::make_binary_function([](float f1, float f2) {
		return std::cyl_bessel_j(f1, f2);
	});
constexpr inline auto cyl_bessel_k =
	float16_t_private::make_binary_function([](float f1, float f2) {
		return std::cyl_bessel_k(f1, f2);
	});
constexpr inline auto cyl_neumann = float16_t_private::make_binary_function([](float f1, float f2) {
	return std::cyl_neumann(f1, f2);
});
constexpr inline auto ellint_1 = float16_t_private::make_binary_function([](float f1, float f2) {
	return std::ellint_1(f1, f2);
});
constexpr inline auto ellint_2 = float16_t_private::make_binary_function([](float f1, float f2) {
	return std::ellint_2(f1, f2);
});
constexpr inline auto ellint_3 =
	float16_t_private::make_trinary_function([](float f1, float f2, float f3) {
		return std::ellint_3(f1, f2, f3);
	});
