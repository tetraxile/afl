...
HK_RESULT_MODULE(5)
HK_DEFINE_RESULT_RANGE(Msbt, 0, 100)
...
HK_DEFINE_RESULT(BufferOverrun, 6)
HK_DEFINE_RESULT(Unimplemented, 7)
HK_DEFINE_RESULT(TagOutOfRange, 8)
HK_DEFINE_RESULT(IncorrectStringLength, 9)
